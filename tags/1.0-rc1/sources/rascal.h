...
RASCAL_API(rrid_t) rascal_connect(const sock_t *target, rascal_dispatcher, void *context RASCAL_OPTIONAL, int proto RASCAL_OPTIONAL);
RASCAL_API(rrid_t) rascal_connect_service(const char *name, int proto, const char *domain, rascal_dispatcher, void *context RASCAL_OPTIONAL, rascal_rcs_filter RASCAL_OPTIONAL);
...
RASCAL_API(rrid_t) rascal_accept_service(const char *name, int proto, const char *domain, rascal_dispatcher, void *context RASCAL_OPTIONAL);
